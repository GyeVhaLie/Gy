...
nadya = LINETCR.LINE()
#nadya.login(#qr=True#)
nadya.login(token='Eqam0MsK7N5OlozRl3u0.GAxNjRaVotCPqjt1w68oGa.hng0FDL+FgduEap52FMxCUv0m4Rwn//lbFj6hMz1i94=')
nadya.loginResult()
...
╚═════════════════════════
"""
tjia="u81a5e726b02f3937294094f55baf0e80"
...
Bots=[mid]
Creator=["u81a5e726b02f3937294094f55baf0e80"]
admin=["u81a5e726b02f3937294094f55baf0e80"]
...
#                            Name = summon(op.param2)
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        nadya.sendText(op.param1, "۝ইह═┅─  " + Name +  "\nSini Bro Jangan Nfintip")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                    else:
                                        nadya.sendText(op.param1, "۝ইह═┅─  " + Name +  "\nSini Gabung Jangan Nyimak Terus")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                else:
                                    nadya.sendText(op.param1, "۝ইह═┅─ " + Name + "\nNjirrrr Betah Amat Jadi Penonton")
                                    time.sleep(0.2)
                                    summon(op.param1,[op.param2])
                        else:
                            pass
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["۝ইह═┅─ " + cName + " \nHoanjaiii Ngapain Ngetag Njirrr","۝ইह═┅─  " + cName + " \n Oittttt Knapa Tag aim ","۝ইह═┅─ " + cName + " \nNGETAG Meleeeeeee Ah"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Nadya")
                ...
                md = ""
		if wait["Sambutan"] == True: md+="╠۝ইह═┅─ ✔️ Sambutan : On\n"
		else:md+="╠۝ইह═┅─ ❌ Sambutan : Off\n"
		if wait["AutoJoin"] == True: md+="╠۝ইह═┅─ ✔️ Auto Join : On\n"
                else: md +="╠۝ইह═┅─ ❌ Auto Join : Off\n"
		if wait["AutoJoinCancel"] == True: md+="╠۝ইह═┅─ ✔️ Auto Join Cancel : On\n"
                else: md +="╠۝ইह═┅─ ❌ Auto Join Cancel : Off\n"                
		if wait["Contact"] == True: md+="╠۝ইह═┅─ ✔️ Info Contact : On\n"
		else: md+="╠۝ইह═┅─ ❌ Info Contact : Off\n"
                if wait["AutoCancel"] == True:md+="╠۝ইह═┅─ ✔️ Auto Cancel : On\n"
                else: md+= "╠۝ইह═┅─ ❌ Auto Cancel : Off\n"
                if wait["inviteprotect"] == True:md+="╠۝ইह═┅─ ✔️ Invite Protect : On\n"
                else: md+= "╠۝ইह═┅─ ❌ Invite Protect : Off\n"                
		if wait["Qr"] == True: md+="╠۝ইह═┅─ ✔️ Qr Protect : On\n"
		else:md+="╠۝ইह═┅─ ❌ Qr Protect : Off\n"
		if wait["AutoKick"] == True: md+="╠۝ইह═┅─ ✔️ Auto Kick : On\n"
		else:md+="╠۝ইह═┅─ ❌ Auto Kick : Off\n"
		if wait["alwaysRead"] == True: md+="╠۝ইह═┅─ ✔️ Always Read : On\n"
		else:md+="╠۝ইह═┅─ ❌ Always Read: Off\n"
		if wait["detectMention"] == True: md+="╠۝ইह═┅─ ✔️ Auto Respon1 : On\n"
		else:md+="╠۝ইह═┅─ ❌ Auto Respon1 : Off\n"		
		if wait["detectMention2"] == True: md+="╠۝ইह═┅─ ✔️ Auto Respon2 : On\n"
		else:md+="╠۝ইह═┅─ ❌ Auto Respon2 : Off\n"	
		if wait["detectMention3"] == True: md+="╠۝ইह═┅─ ✔️ Auto Respon3 : On\n"
		else:md+="╠۝ইह═┅─ ❌ Auto Respon3 : Off\n"			
		if wait["kickMention"] == True: md+="╠۝ইह═┅─ ✔️  Responkick   On\n"
		else:md+="╠۝ইह═┅─ ❌  Responkick  Off\n"				
		if wait["Sider"] == True: md+="╠۝ইह═┅─ ✔️ Auto Sider : On\n"
		else:md+="╠۝ইह═┅─ ❌ Auto Sider: Off\n"	
		if wait["Simi"] == True: md+="╠۝ইह═┅─ ✔️ Simisimi : On\n"
		else:md+="╠۝ইह═┅─ ❌ Simisimi: Off\n"
